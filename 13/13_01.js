...
// 商品の定義
var itemList = [
    { id: '0001', name: 'ソファベッド', price: '¥70,000', tags: ['ベッド', 'ソファ', '寝具'] },
    { id: '0002', name: 'シングルベッド', price: '¥60,000', tags: ['ベッド', 'ソファ', '寝具'] },
    { id: '0003', name: '子ども用ベッド', price: '¥32,000', tags: ['ベッド', 'ソファ', '寝具', '子ども部屋家具'] },
    { id: '0004', name: 'ソファ', price: '¥70,000', tags: ['ソファ'] },
    { id: '0005', name: 'キューブボックス', price: '¥8,000', tags: ['家具・ラック', '収納システム'] },
    { id: '0006', name: 'オープンラック', price: '¥50,000', tags: ['家具・ラック', '収納システム'] },
    { id: '0007', name: 'コンピュータデスク', price: '¥60,000', tags: ['テーブル・椅子'] },
    { id: '0008', name: 'サイドテーブル', price: '¥20,000', tags: ['テーブル・椅子'] },
    { id: '0009', name: 'ダイニングテーブル', price: '¥100,000', tags: ['テーブル・椅子'] },
    { id: '0010', name: '子ども部屋用収納', price: '¥10,000', tags: ['収納システム', '子ども部屋家具'] },
    { id: '0011', name: '果物ナイフ', price: '¥1,500', tags: ['包丁'] },
    { id: '0012', name: 'ボウル', price: '¥900', tags: ['食器'] },
];
...
function setMainMenu() {
    ...
    cate1.forEach(cate => {
        ...
        option.value = cate;    // optionの値に配列の値を代入
        option.text = cate;     // optionの表示文字列に配列の値を代入
